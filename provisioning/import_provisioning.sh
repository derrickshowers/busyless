...
gpg --quiet --batch --yes --decrypt --passphrase="$PROVISIONING_PASSWORD" --output provisioning/BusylessIntentsAppStore.mobileprovision provisioning/BusylessIntentsAppStore.mobileprovision.gpg
